...
namespace ETM.API.Infrastructure.Migrations
{
    ...
    [Migration("20240403050025_cascadeDeleteOff")]
            ...
            modelBuilder.Entity("ETM.API.Core.Entities.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = 1,
                            CreatedOn = new DateTime(2024, 4, 3, 5, 0, 25, 30, DateTimeKind.Utc).AddTicks(4790),
                            ModifiedBy = 1,
                            ModifiedOn = new DateTime(2024, 4, 3, 5, 0, 25, 30, DateTimeKind.Utc).AddTicks(4791),
                            Name = "Engineering"
                        },
                        new
                        {
                            Id = 2,
                            CreatedBy = 1,
                            CreatedOn = new DateTime(2024, 4, 4, 5, 0, 25, 30, DateTimeKind.Utc).AddTicks(4796),
                            ModifiedBy = 1,
                            ModifiedOn = new DateTime(2024, 4, 5, 5, 0, 25, 30, DateTimeKind.Utc).AddTicks(4803),
                            Name = "IT"
                        });
                });
